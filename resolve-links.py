...
print('-----------------------------------------------')
print('')
print('Links OK:         {0}'.format(count_links_ok))
print('')
print('Links added:      {0}'.format(count_links_added))
print('')
print('Homepage files:   {0}   (files/links specific only for homepage)'.format(
    count_homepage_files))
print('')
print(
...
print('')
print('Broken links:     {0}   (should be fixed manually)'.format(count_links_broken))
